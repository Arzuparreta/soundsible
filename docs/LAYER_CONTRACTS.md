...
1. **Setup funnel model:** backend support for `setup_session_id`, `setup_session_started`,
   `setup_step_*`, and `setup_first_play` is done (see §3.1). SolidJS client wiring
   remains part of the `new-ui` parity work.
