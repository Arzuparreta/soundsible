...
export const en = {
  ...
  nowPlaying: {
    ...
    contextQueueFrom: 'From {source}',
    laneHintCurrent: 'The song playing right now.',
    laneHintManual: 'What you asked for by hand. It plays before anything else.',
    laneHintContext: 'What is left of {source}, where this playback started.',
    laneHintContextPlain: 'What is left of the selection this playback started from.',
    laneHintGenerated: 'Added on its own once the queue runs out.',
