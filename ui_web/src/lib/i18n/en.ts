...
export const en = {
  ...
  autoMode: {
    ...
    dj: {
      ...
      choose: 'Choose how Auto mixes', chooseHint: 'This changes the transition technique, not the music style.',
      adaptive: 'Adaptive', adaptiveTrait: 'Chooses the best mix for each pair',
      longBlend: 'Long blend', longBlendTrait: 'Harmonic · 16–32 bars · subtle effects',
      cutsDrops: 'Cuts & drops', cutsDropsTrait: 'Shorter runs · marked changes · echo cuts',
      openFormat: 'Open format', openFormatTrait: 'Wide jumps · bridge tracks · structural changes',
      direction: 'Music direction', directionHint: 'Changes what comes next; the DJ still takes care of the mix.',
      commandPlaceholder: 'For example: more danceable, then take me towards funk…',
      commandAria: 'Redirect the session', send: 'Send direction',
      energy: 'Energy', energySoft: 'Softer', energyHigh: 'More intense',
      selection: 'Track selection', discover: 'Discover', balanced: 'Balanced', familiar: 'Familiar',
      request: 'Request a track', requestEta: 'Within 3 tracks', requests: 'Your requests',
      ...
      searchEmpty: 'Search for an exact track', requestAction: 'Request',
      technique: {
