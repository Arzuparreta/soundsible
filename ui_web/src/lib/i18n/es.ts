...
export const es: Dict = {
  ...
  autoMode: {
    ...
    dj: {
      label: 'DJ', change: 'Cambiar', changeCurrent: 'Cambiar DJ. Actual: {dj}',
      choose: 'Elige cómo mezcla Auto', chooseHint: 'Cambia la técnica de transición, no el estilo de música.',
      adaptive: 'Adaptativo', adaptiveTrait: 'Elige la mejor mezcla para cada pareja',
      longBlend: 'Mezcla larga', longBlendTrait: 'Armónico · 16–32 compases · efectos sutiles',
      cutsDrops: 'Cortes y drops', cutsDropsTrait: 'Tramos cortos · cambios marcados · cortes con eco',
      openFormat: 'Open format', openFormatTrait: 'Saltos amplios · temas puente · cambios estructurales',
      direction: 'Rumbo musical', directionHint: 'Cambia lo que viene; el DJ sigue encargándose de la mezcla.',
      commandPlaceholder: 'Por ejemplo: más bailable y llévame hacia el funk…',
      commandAria: 'Redirigir la sesión', send: 'Enviar rumbo',
      energy: 'Energía', energySoft: 'Más suave', energyHigh: 'Más intensa',
      selection: 'Selección de temas', discover: 'Descubrir', balanced: 'Equilibrada', familiar: 'Conocida',
      request: 'Pedir canción', requestEta: 'En 3 temas o menos', requests: 'Tus peticiones',
      ...
      searchEmpty: 'Busca una canción exacta', requestAction: 'Pedir',
      technique: {
        long_blend: 'Mezcla larga', bass_swap: 'Cambio de bajos', filter_blend: 'Mezcla con filtro',
        echo_cut: 'Corte con eco', structural_fade: 'Cambio estructural', safe_fade: 'Fundido suave',
      },
    },
  },
  autoplay: {
