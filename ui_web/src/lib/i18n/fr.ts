...
export const fr: Dict = {
  ...
  autoMode: {
    ...
    dj: {
      ...
      choose: 'Choisissez comment Auto mixe', chooseHint: 'Cela change la transition, pas le style musical.',
      adaptive: 'Adaptatif', adaptiveTrait: 'Choisit le meilleur mix pour chaque paire',
      ...
      direction: 'Direction musicale', directionHint: "Change la suite ; le DJ s'occupe toujours du mix.",
      commandPlaceholder: 'Par exemple : plus dansant, puis vers le funk…',
      commandAria: 'Rediriger la session', send: 'Envoyer la direction',
      energy: 'Énergie', energySoft: 'Plus douce', energyHigh: 'Plus intense',
      selection: 'Choix des morceaux', discover: 'Découvrir', balanced: 'Équilibré', familiar: 'Familier',
      request: 'Demander un morceau', requestEta: 'Sous 3 morceaux', requests: 'Vos demandes',
      ...
      searchEmpty: 'Recherchez un morceau précis', requestAction: 'Demander',
      technique: {
