...
export const zh: Dict = {
  ...
  autoMode: {
    ...
    dj: {
      ...
      choose: '选择自动模式的混音方式', chooseHint: '这里只改变转场技巧，不改变音乐风格。',
      adaptive: '自适应', adaptiveTrait: '为每对歌曲选择最佳混音',
      ...
      direction: '音乐方向', directionHint: '改变接下来的音乐；DJ 仍会处理混音。',
      commandPlaceholder: '例如：更适合跳舞，然后转向放克…',
      commandAria: '改变会话方向', send: '发送方向',
      energy: '能量', energySoft: '更柔和', energyHigh: '更强烈',
      selection: '选曲', discover: '探索', balanced: '平衡', familiar: '熟悉',
      request: '点播歌曲', requestEta: '3 首以内', requests: '你的点播',
      ...
      searchEmpty: '搜索一首确切的歌曲', requestAction: '点播',
      technique: {
