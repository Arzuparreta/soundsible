...
- **Universal Sync**: Your library, playlists, metadata, configurations... all synchronised along your devices. Queue is synced when you accept "Resume from [device]?" on another device.
